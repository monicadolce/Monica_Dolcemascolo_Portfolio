...
export default function Resume () {
  return (
    ...
    <a href='https://drive.google.com/file/d/1LFJgxmtNofbaxel4AM-xVo6UPwWqqrH_/view?usp=share_link' target={'_blank'}><h1 id= 'experience-link' className='resume-text'>Experience</h1></a>
    </div>
    <div className="container experience-wrapper">
      ...
      <div className="timeline-block timeline-block-left">
        ...
        <div className="timeline-content">
          ...
          <p id= 'resume-link' className='resume link'><a href='https://drive.google.com/file/d/1LFJgxmtNofbaxel4AM-xVo6UPwWqqrH_/view?usp=share_link' target={'_blank'}>Click here to go to my resume and find out about my skills, education, certifications and more!</a></p>
        </div>
      </div>
    </div>
  </div>
